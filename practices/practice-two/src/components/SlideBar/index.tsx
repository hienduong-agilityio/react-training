...
export default function SideBar({
  ...
  return (
    ...
    >
      {/* SideBar */}
      <div className="fixed bottom-0 right-0 top-0 flex h-full flex-col border-l border-neutral-200 bg-white/80 text-black backdrop-blur-xl dark:text-black w-[336px] translate-x-0">
        {children}
      </div>
    </div>
  );
