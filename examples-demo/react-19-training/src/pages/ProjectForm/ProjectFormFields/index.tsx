...
// Enums
import { BUTTON_COLORS, STATUS } from '../../../enums';
  ...
  return (
    <form className='relative space-y-4' onSubmit={handleSubmitForm}>
        ...
        <div className='flex flex-col gap-4 w-1/2'>
          ...
          <div className='flex justify-between items-center gap-4'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <InputField id='timeEnd' name='timeEnd' type='date' defaultValue={initialFormValues.timeline?.timeEnd} />
            </div>
          </div>
      ...
      <div className='flex items-center rounded-b-xl bg-white gap-5 py-5 px-4 justify-end border-gray-200'>
        <Button type='button' onClick={handleCancelForm} color={BUTTON_COLORS.DANGER}>
          Cancel
        </Button>
        <Button type='submit' disabled={isMutating} color={BUTTON_COLORS.PRIMARY}>
