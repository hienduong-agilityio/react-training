...
// Layouts
import { AuthLayout, MainLayout, ProjectLayout } from '../layout';
      ...
      children: [
        {
          path: ROUTE.LOGIN,
          element: (
            <ErrorBoundary fallback={<ErrorDisplay errorMessage='Something went wrong with LoginForm!' />}>
              <LoginForm />
            </ErrorBoundary>
          )
        },
        {
          path: ROUTE.REGISTER,
          element: (
            <ErrorBoundary fallback={<ErrorDisplay errorMessage='Something went wrong with RegisterForm!' />}>
              <RegisterForm />
            </ErrorBoundary>
          )
        }
